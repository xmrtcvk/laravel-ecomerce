                ...
                <div class="row">
                    <div class="col-lg-6">
                        ...
                        <div class="form-check">
                            <input class="form-check-input" type="checkbox" name="is_admin" id="is_admin" @checked($user->is_admin)>
                      ...
                      <div class="col-lg-6">
                        <br>
                        <div class="form-check">
                            <input class="form-check-input" type="checkbox" name="is_active" id="is_active" @checked($user->is_active)>
